...
tiles = {
	"grass": "assets/grass_128x64.png",
	"tombstone": "assets/squaretombstone_128x128.png"
}
	...
	this.draw = function(x, y)
	{
		for (var m_x = 0; m_x < width; m_x = m_x + 1)
		{
			for (var m_y = 0; m_y < height; m_y = m_y + 1)
			{
				...
				context.drawImage(tiles.grass, x+render_x, y+render_y);
			}
		}
		...
		context.drawImage(tiles.tombstone, x+render_x_t, y+render_y_t);
	}
	this.width = width;
	this.height = height;
}
